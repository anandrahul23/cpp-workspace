...
namespace fp_math
{
    ...
    template <unsigned short precision> friend
    constexpr auto operator==(const number<precision> &lhs, const number<precision> &rhs)  noexcept; 

        private : storage_type value_ = 0;
    };
...
namespace fp_math::test
{
    ...
    static_assert(n9{42.0000001} == n9{42.0000001});
}
