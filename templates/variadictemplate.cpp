...
template <typename... Ts> void printMulti(std::ostream& os, Ts const& ... values)
{
...
int main()
{
    std::cout<<"Rahul Anand"<<std::endl;

    printMulti(std::cout, "abc", "cde" , "ghi", 1,  1.5, "xyz");

    //AClass a;

    f<int,int,int> (1,2,3, 2.0);
